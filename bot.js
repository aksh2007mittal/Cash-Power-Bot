...
var bot_token = '5385799625:AAEl_oJzqlrXYxoRO1Gc8_egw5wUxnCsSow'; //YOUR BOT TOKEN HERE

var bot_name = 'Cash_Power_TBot'; // Bot Name
...
const admin_id = 1080680449;

const admin_id2 = 1080680449;
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        ...
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="tg://user?id=1080680449">Aksh Bot Maker 🔥</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
      ...
      return 0;
        ...
        ctx.replyWithMarkdown( 
            ...
            bot.telegram.sendMessage(pay, "<b>✅ New Withdrawal Requested ✅\n\n🟢 User : <a href='tg://user?id=" + ctx.from.id + "'>" + ctx.from.id + "</a>\n\n🚀Amount : " + toWith + " " + currency + "\n⛔ Address :</b> <code>" + wallet + "</code>\n\n<b>💡 Bot: @" + ctx.botInfo.username + "</b>", { parse_mode: 'html' })
             ...
             let url = 'https://full2sms.in/api/v1/disburse/paytm?mid='+mid+'&mkey='+mkey+'&guid='+swg+'&amount='+amount+'&mobile='+wallet+'&info='+comment+'';
